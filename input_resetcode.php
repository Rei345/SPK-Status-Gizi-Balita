...
<div class="container">
	<div class="screen">
		<div class="screen__content">
			<form class="login" method="post" action="verify_resetpass.php">
				...
				<div class="login__field">
					...
					<input type="text" name="code" class="login__input" placeholder="Masukkan Kode" required>
				</div>			
				<button class="button login__submit">
					<span class="button__text">Kirim</span>
